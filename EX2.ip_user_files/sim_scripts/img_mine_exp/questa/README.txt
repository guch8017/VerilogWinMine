...
#
# Generated by export_simulation on Fri Dec 13 11:57:20 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './img_mine_exp.sh' script.

./img_mine_exp.sh -reset_run
...
./img_mine_exp.sh -noclean_files

For more information on the script, please type './img_mine_exp.sh -help'.
