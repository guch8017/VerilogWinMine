...
#
# Generated by export_simulation on Thu Dec 12 15:49:36 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './img_1.sh' script.
...
./img_1.sh -noclean_files

For more information on the script, please type './img_1.sh -help'.
