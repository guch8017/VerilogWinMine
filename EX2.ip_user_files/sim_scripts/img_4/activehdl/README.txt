...
#
# Generated by export_simulation on Thu Dec 12 16:40:34 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './img_4.sh' script.
...
./img_4.sh -noclean_files

For more information on the script, please type './img_4.sh -help'.
