...
#
# Generated by export_simulation on Thu Dec 12 16:42:37 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './img_5.sh' script.
...
./img_5.sh -noclean_files

For more information on the script, please type './img_5.sh -help'.
